...
python run_experiment_rq0_history_length.py
echo "$(date '+%d-%m-%Y %H:%M') RQ0: Network Hidden Nodes"
python run_experiment_rq0_network_hidden_nodes.py
echo "$(date '+%d-%m-%Y %H:%M') RQ0: Reward Functions"
python run_experiment_rq0_reward_function.py
echo "$(date '+%d-%m-%Y %H:%M') RQ0: Scheduling Times"
python run_experiment_rq0_scheduling_time.py
echo "$(date '+%d-%m-%Y %H:%M') RQ0: Tableau Action Size"
python run_experiment_rq0_tableau_action_size.py
